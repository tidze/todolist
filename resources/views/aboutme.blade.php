...
@section('body')
    ...
    <div class="relative z-10 flex flex-col h-full bg-black bg-opacity-90 text-gray-300">
        <header class="relative z-10 shadow-md shadow-orange-500">
            <nav>
                <ul class="flex px-4">
                    <li class="m-2 flex justify-center items-center">
                        <div class="w-4 h-4 rounded-full bg-orange-500"></div>
                    </li>
                    <li class="m-2">{{ env('DEV_NAME') }}</li>
                    <li class="m-2 flex justify-center items-center font-light text-[10px]"><a href="#about">Developer</a></li>
                    <li class="m-2 ml-auto"><a href="{{ asset('about-me-assets/MyResume-539[www.cvbuilder.me].pdf') }}">Resume <span class="font-bold">&#8681;</span></a></li>
                    {{-- <li class="m-2"><a href="#projects">Projects</a></li> --}}
                    <li class="m-2"><a href="#infoBar">Contact</a></li>
                </ul>
            </nav>
        </header>
        <main class="flex-auto flex sm:flex-row flex-col bg-zinc-800  p-4">
            ...
            <section class="sm:flex-1 flex flex-col justify-center sm:items-start sm:p-3" id="info">
                ...
                <p class="sm:w-[600px] m-1 sm:text-sm text-lg">
        ...
        <footer class="text-center py-2 border-t border-orange-500 border-opacity-50" id="infoBar">
            <ul class="flex flex-row justify-around items-center">
                ...
                <li class="font-bold flex flex-col justify-center items-center cursor-pointer">Follow Me
