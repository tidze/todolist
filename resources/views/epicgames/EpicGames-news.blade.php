...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/EpicGames-news.css') }}">
...
<body>
    ...
    <div id="main-content-container">
        <div class="box-type-alpha">
            <div class="box-type-alpha-label">News</div>
            <div class="card-view-type-alpha">
                <a href="#">
                    <div>
                        <img src="assets/images/transparent.png" alt="">
                        <div class="white-effect-type-alpha"></div>
                    </div>
                    <p>5D ago</p>
                    <p>
                        Prosperity awaits you in Halcyon, located on the edge of the galaxy! The Outer Worlds is 50% for
                        a limited time on the Epic Games Store!
                    </p>
                    <p>View more</p>
                </a>
            </div>
        ...
        <div class="box-type-alpha-beta">
            <div class="card-view-type-beta">
                <a href="#">
                    <div class="card-view-type-beta-image-holder">
                        <img src="assets/images/transparent.png" alt="">
                        <div class="white-effect-type-alpha"></div>
                    </div>
                    <div class="card-view-type-beta-info-holder">
                        <p>5D ago</p>
                        <p>
                            Prosperity awaits you in Halcyon, located on the edge of the galaxy! The Outer Worlds is 50%
                            for a limited time on the Epic Games Store!
                        </p>
                        <p>View more</p>
                    </div>
                </a>
